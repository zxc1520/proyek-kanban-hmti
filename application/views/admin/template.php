...
<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" href="<?= base_url() ?>assets/vendor/usertemp/images/LOGO HMTI.png">
    ...
    <nav id="nav" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
          ...
          <li>
            <a href="<?= base_url().'admin/Sampul' ?>"><i class="fa fa-fw fa-file-image-o"></i> Sampul</a>
          </li>
          <li>
          ...
          <li>
            <a href="<?= base_url().'admin/Kanban' ?>">Kanban</a>
          </li>
